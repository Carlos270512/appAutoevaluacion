...
<head>
  ...
  <!-- STYLESHEET -->
  <link rel="stylesheet" href="../menu/style.css?v=1" />
          ...
          <div class="container-form">
            ...
            <form action="" method="post" class="form">
              ...
              <div class="user line-input">
                ...
                <input type="text" name="usuario" value="<?php if ($resultado) echo $resultado['usuario']; ?>" required="" onkeypress="return soloLetras(event)" onkeyup="javascript:this.value=this.value.toUpperCase();" style="font-size: 13px" placeholder="CÓDIGO DE USUARIO" readonly="">
              </div>

              <div class="user line-input">
                <div class="icon2"><i class="fa fa-user"></i></div>

                <input type="text" name="nombre" value="<?php if ($resultado) echo $resultado['nombre']; ?>" required="" onkeypress="return soloLetras(event)" placeholder="APELLIDOS Y NOMBRES" onkeyup="javascript:this.value=this.value.toUpperCase();" style="font-size: 13px">
              </div>
              ...
              <div class="password line-input">
                ...
                <input type="password" name="clave" placeholder="NUEVA CONTRASEÑA" required="" style="font-size: 13px">
              </div>
              <div class="password line-input">
                <div class="icon2"><i class="fa fa-lock"></i></div>

                <input type="password" name="clave2" placeholder="CONFIRMAR NUEVA CONTRASEÑA" required="" style="font-size: 13px">
              </div>
              <?php if (!empty($error)): ?>
                <div class="mensaje">
                  <?php echo $error; ?>
