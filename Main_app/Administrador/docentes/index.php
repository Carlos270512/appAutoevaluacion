...
$sentencia_select = $con->prepare('SELECT * FROM login WHERE tipo LIKE "Docente" ORDER BY nombre ASC');
...
if (isset($_POST['btn_buscar'])) {
  ...
  $select_buscar = $con->prepare(
    '
			SELECT * FROM login WHERE usuario LIKE :campo OR usuario LIKE :campo;'
  );
...
<head>
  ...
  <link rel="stylesheet" href="css/botones.css?v=3">
  ...
  <section>
    <div class="contenedor">
      <div class="logo-title">
        <div class="icon" style="width: 50px; height: 50px; font-size: 48px; margin-top: 10px; margin-left: 60px;"><i class="icon5 fa fa-user"></i></div>
        <h2 style="color: black; font-size: 28px; margin-top: -25px; margin-left: 10px;"><b>Docentes Registrados</b> </h2>
      </div>
      ...
      <table id="example" class="hover" class="display" style="width:50%; border: #f2b440 2px solid;">
        <thead class="tabla" style="color: black">
          <tr class="head" style="background-color: #914a31;">
            <th style="text-align: center;">CÓDIGO DE USUARIO</th>
        ...
        <tbody style="background-color: #fff;">
          <?php foreach ($resultado as $fila): ?>
            <tr style='color: black;'>
              <td style="font-size: 12px"><?php echo $fila['usuario']; ?></td>
        ...
        <tfoot>
          <tr class='noSearch hide' style="background-color: #914a31;">
            <th style="text-align: center;">COOD DOCENTE</th>
