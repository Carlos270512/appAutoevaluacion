      ...
      <div class="container-form">
        ...
        <form action="" method="post" class="form">
          ...
          <div class="password line-input">
            ...
            <input type="password" name="clave" style="font-size: 13px" placeholder="NUEVA CONTRASEÑA" required="">
          </div>
          <div class="password line-input">
            <div class="icon2"><i class="fa fa-lock"></i></div>

            <input type="password" name="clave2" style="font-size: 13px" placeholder="CONFIRMAR NUEVA CONTRASEÑA" required="">
          </div>
          <?php if (!empty($error)): ?>
            <div class="mensaje">
              <?php echo $error; ?>
