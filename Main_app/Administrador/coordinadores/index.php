...
$sentencia_select = $con->prepare('SELECT * FROM login WHERE tipo LIKE "Coordinador" ORDER BY nombre ASC');
...
<body>
  ...
  <div class="contenedor">
    <div class="logo-title">
      ...
      <h2 style="color: black; font-size: 28px; margin-top: -25px; margin-left: 10px;"><b>Coordinadores Registrados</b> </h2>
    </div>
