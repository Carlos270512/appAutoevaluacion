...
<header>
  <div id="headerr">
    <ul class="nav">
      ...
      <li><img src="../../image/logo_inicio.ico"

          width="65" height="65" style="margin-left: 1px" /></li>
  ...
  <div id="inicio_admin" class="menu-collapsed">
    ...
    <div id="profile">
      ...
      <div id="name"><span><b>Bienvenido:</b> <br>
          <h4 style="color: white; font-size: 16px;margin-top: 12px;"><b><span class="fa fa-user icon-menu" style="margin-right: 5px"></span><?php echo $_SESSION['usu']['usuario'] ?></b></h4>
        </span></div>
    </div>
...
<div class="icon" style="display: inline-block;"><i class="icon6 fa fa-search"></i>
 ...
 <a href="convertidor.php" class="button3" style="position: relative;top:-37px; left: 930px;"><i class="fa fa-files-o"></i> Ver Todos los Reportes</a>
    ...
    <table id="datos" style="border: #270D07 3px solid;margin-top: 30px;">
    <thead class="tabla">
    <tr class="head">
      <td style="font-size: 12px">FECHA</td>
      <td style="font-size: 12px">EVALUADOR</td>
    ...
    $sentencia = "
    SELECT 
      g.id_coevaluacion_general AS id, 
      g.fecha, 
    ...
    WHERE 
        g.fecha BETWEEN '$fecha_inicio' AND '$fecha_final'
    ORDER BY 
    g.fecha ASC";
      ...
      while($fila=$resultado->fetch_assoc())
      {
        ...
        echo "<td style='font-size: 12px;'>"; echo $fila['nombre_coordinador']; echo "</td>";
        echo "<td style='font-size: 12px;'>"; echo $fila['carrera']; echo "</td>";
        echo "<td style='font-size: 12px;'>"; echo $fila['coevaluacion']; echo "</td>";
        ...
        echo "<td><div align='center'><a href='update.php?id=" . $fila['id'] . "'> <button type='button' class='btn__env'><i class='icon3 fa fa-envelope'></i> Recomendación</button> </a></div></td>";
        echo "</tr>";
      }
