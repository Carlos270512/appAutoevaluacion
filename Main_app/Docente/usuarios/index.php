...
header('Location:../Usuario/');
	...
	$sentencia_select=$con->prepare('SELECT *FROM login ORDER BY usuario ASC');
...
<div id="headerr">
      <ul class="nav">
        ...
        <li><h4 style="color: white; font-size: 20px; margin-top: 20px; margin-left: 10px"><b>Evaluacion de Responsabilidades</b></h4></li>
     </ul>
</div>
</header>
...
<section>
	<div class="contenedor">
		<div class="logo-title" style="margin-top: 60px">
                <div class="icon"><i class="fa fa-user"></i></div>
                <h2 style="color: white; font-size: 30px;"><b>Usuarios Registrados</b> </h2>
            </div>
...
<style type="text/css">
  ...
  margin-bottom: 50px;
    ...
    <form action="" class="formulario" method="post">
        ...
        <input id="searchTerm" type="text" placeholder="Nombre de Usuario" class="user" onkeyup="doSearch()" onkeypress="return soloLetras(event)">
      </form>
