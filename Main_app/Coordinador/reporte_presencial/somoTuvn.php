              ...
              <div class="dropdown" id="dropdown">
                ...
                <div class="dropdown__list" style="margin-left: -2em;">
                  <a href="../reporte_presencial/convertidor.php" class="dropdown__link">
                    ...
                    <span>Reporte de Evaluaci¨®n</span>
                  </a>
                </div>
              </div>
            </li>
            ...
            <li>
              <div class="dropdown" id="dropdown">
                ...
                <div class="dropdown__list" style="margin-left: -2em;">
                  <a href="../reporte_presencial/convertidor.php" class="dropdown__link">
                    <i class="icon ph-bold ph-file"></i>
                    <span>Reporte de Evaluacion</span>
                  </a>
    ...
    <div class="cont" style="width: 1500px;">
      ...
      <table id="example" style="border: #f2b440 2px solid;margin-top: 1px; width:95%">
        ...
        <tbody style="background-color: #fff;">
          ...
          $coordinador_id = $_SESSION['usu']['id']; // Asumiendo que el id del coordinador est¨¢ en la sesi¨®n

          $sentencia = "SELECT g.id ,g.fecha,g.id_coordinador, l.nombre AS coordinador, g.docente, g.carrera, g.coevaluacion, g.archivopdf, g.tipo
            FROM coevaluacion_general g
            JOIN login l ON g.id_coordinador = l.id
            WHERE g.id_coordinador = '$coordinador_id' OR g.id_coordinador = '219'
            ORDER BY g.fecha ASC";

          $resultado = $conexion->query($sentencia) or die(mysqli_error($conexion));
          while ($fila = $resultado->fetch_assoc()) {
            if (($fila['archivopdf']) && ($fila['coevaluacion'] === "GESTION DE SOMOS TUVN EN LOS DOCENTES") && ($fila['tipo'] === "docente" && $fila['id_coordinador'] != 219 || $fila['tipo'] === "docente" && $fila['id_coordinador'] == 219)) {
              ...
              echo "<td>
                <div>";
              if ($fila['tipo'] === "docente" && $fila['id_coordinador'] == 219) { 
                echo "
                      <a href='descargarCoorA.php?id=219&text=" . $fila['docente'] . "' target='_blank' class='botones botones-pdf'>
                        <i class='fa fa-file-pdf-o'></i>
                      </a>
                   </div>
                   <br>
                  <div>
                      <form action='cargarPDFcoor.php' method='POST' enctype='multipart/form-data'>
