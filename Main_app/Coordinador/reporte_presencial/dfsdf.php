    ...
    <div class="cont" style="width: 1500px;">
      ...
      <table id="example" style="border: #f2b440 2px solid;margin-top: 1px; width:95%">
        ...
        <tbody style="background-color: #fff;">
          ...
          $sentencia = "SELECT g.id, g.fecha, l.nombre AS coordinador,l.id, g.docente, g.carrera, g.coevaluacion, g.archivopdf, g.tipo
          ...
          while ($fila = $resultado->fetch_assoc()) {
            if (($fila['archivopdf']) && (($fila['tipo'] === "docente") || ($fila['tipo'] === "coordinadorA"))) {
              ...
              if ($fila['id'] == 219) {
                echo "
                      <a href='descargarCoorA.php?id=219' target='_blank' class='botones botones-pdf'>
