    ...
    <div class="container-form">
        <div class="header">
            <div class="logo-title">
                <div class="icon"><i class="fa fa-user"></i></div>
                <h2 style="color: white; font-size: 20px; margin-top: 10px;"><b>Formulario de Registro de Usuarios</b> </h2>
            </div>
        </div>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" class="form">
            ...
            <div class="user line-input">
                ...
                <input type="text" placeholder="Nombre de Usuario" name="usuario" required="" onkeypress="return soloLetras(event)">
            </div>

            <div class="password line-input">
                <div class="icon2"><i class="fa fa-bars"></i></div>
                <select class="caja" name="tipo" required>
